...
--   term_mode = "t",
--   command_mode = "c",
--   vscode nvim is really nice, because your editor doesnt feel like a laggy piece of shit
...
-- Comment
keymap("n", "<leaderp/", "<cmd>lua require('Comment.api').toggle.linewise.current()<CR>", opts)
